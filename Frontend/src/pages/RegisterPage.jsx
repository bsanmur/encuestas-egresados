...
export default function RegisterPage() {
  ...
  async function onSubmit(e) {
    ...
    // Validation
    if (!form.email || !form.password || !form.fullName || !form.graduationYear || !form.major || !form.schoolId || !form.employmentStatus) {
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={onSubmit}>
        ...
        <div>
          ...
          {schools.length === 0 && !loadingSchools && (
            <p className="text-xs text-red-500 mt-1">No schools available. Please contact administrator.</p>
          )}
        </div>
