...
export const adminService = {
  ...
  listSurveys: () => api.get("/admin/surveys").then((r) => r.data),
  getSurvey: (id) => api.get(`/admin/surveys/${id}`).then((r) => r.data),
  createSurvey: (data) => api.post("/admin/surveys", data).then((r) => r.data),
  updateSurvey: (id, data) => api.put(`/admin/surveys/${id}`, data).then((r) => r.data),
  deleteSurvey: (id) => api.delete(`/admin/surveys/${id}`).then((r) => r.data),
  getSurveyAnalytics: (id) => api.get(`/admin/surveys/${id}/analytics`).then((r) => r.data),
